...
<body>
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item ml-0">
            <h4 class="mb-0">Sistem Informasi Agenda Kegiatan OSIS</h4>
          </li>
  ...
  <div class="sidebar-header">
    <img src="<?php echo base_url('images/logo.jpg') ?>" alt="logo" class="brand-logo-img">
...
.brand-username {
  ...
  color: #333;
  font-weight: bold;
  margin-left: 10px; /* Spasi antara gambar dan teks */
}
        ...
        <li class="nav-item">
            <a class="nav-link" href="/home/lprn">
        ...
        <li class="nav-item">
            <a class="nav-link" href="/home/activity">
                ...
                <span class="menu-title">History Login</span>
            </a>
      ...
      <?php
        if(session()->get('level')==1  ){
          ?>
 <li class="nav-item">
            <a class="nav-link" href="hsdelete">
                <i class="typcn typcn-lock-closed-outline menu-icon"></i>
                <span class="menu-title">History Delete</span>
            </a> 
        </li>
         <?php } ?>
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="/home/euser" aria-expanded="false" aria-controls="icons">
