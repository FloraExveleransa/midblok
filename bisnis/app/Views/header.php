...
<body>
  ...
  <div class="container-scroller">
    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="/home/mskdata" aria-expanded="false" aria-controls="ui-basic">
                <i class="typcn typcn-document-add menu-icon"></i>
                <span class="menu-title">Masukkan Data</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="laporanharian" aria-expanded="false" aria-controls="form-elements">
